...
y_tst = np.zeros(len(X_test))
dump_svmlight_file(X_trn_feature, y_train, 'trn.sps', zero_based=False)
dump_svmlight_file(X_tst_feature, y_tst, 'tst.sps' , zero_based=False)
